...
-- ----------------------------
-- Table structure for t_busi_task_ext
-- ----------------------------
DROP TABLE IF EXISTS `t_busi_task_ext`;
CREATE TABLE `t_busi_task_ext`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `instance_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '流程实例Id',
  `task_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '任务Id',
  `busi_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '业务key',
  `version` int(11) NULL DEFAULT 0 COMMENT '版本号',
  `start_date` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_date` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `updator` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改人',
...
CREATE TABLE `t_deploy`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `application` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '业务流程控制器名称',
  `busi_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '流程定义Key',
  `process_define_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '流程定义Id',
  `category` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '类别',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '流程名称',
  `pub_sts` tinyint(3) NULL DEFAULT NULL COMMENT '发布状态',
  `resource_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '流程图资源地址',
  `version` int(11) NULL DEFAULT 0 COMMENT '版本号',
...
-- ----------------------------
-- Table structure for t_hi_busi_task
-- ----------------------------
DROP TABLE IF EXISTS `t_hi_busi_task`;
CREATE TABLE `t_hi_busi_task`  (
